...
function Banner() {
  return (
    <div className="w-full h-[700px] bg-banner bg-no-repeat bg-cover relative">
      ...
      <div className="h-full flex items-center justify-center gap-8 z-20 relative container">
        ...
        <div className="flex flex-col gap-5 items-baseline w-4/6">
          ...
          <div className="flex flex-col gap-4 z-50 max-w-[500px]">
            ...
            <p className="text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt consectetur fugit id facilis adipisci. Sint quam cum dolore, nam nobis eveniet, repellendus vel reprehenderit dolorem pariatur porro rerum, neque ipsum?
            </p>
        ...
        {/* right side */}
        <div className="w-2/6">
          <div className="flex justify-start w-full h-auto group cursor-pointer relative">
            <img src={Thumpnail} alt="" className="w-full h-auto object-cover aspect-[5/6]" />
            <div className="absolute inset-0 flex items-center justify-center backdrop-blur-sm opacity-0 group-hover:opacity-100">
              <img
                src={IconPlay}
                alt=""
                className="hidden group-hover:block w-16 h-16 absolute z-20 transform -translate-x-1/2 -translate-y-1/2"
              />
            </div>
          </div>
        </div>
